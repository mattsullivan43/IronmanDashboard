...
const navItems: NavItem[] = [
  ...
  { label: 'Revenue', icon: TrendingUp, path: '/revenue', shortcut: '2' },
  { label: 'Unit Economics', icon: Calculator, path: '/unit-economics', shortcut: '3' },
  { label: 'P&L', icon: DollarSign, path: '/profitability', shortcut: '4' },
  { label: 'Cash & Burn', icon: Flame, path: '/cash-burn', shortcut: '5' },
  { label: 'BoomLine', icon: Construction, path: '/boomline', shortcut: '6' },
  { label: 'AI Receptionist', icon: Bot, path: '/ai-receptionist', shortcut: '7' },
  { label: 'Clients', icon: Users, path: '/clients', shortcut: '8' },
  { label: 'Calendar', icon: Calendar, path: '/calendar', shortcut: '9' },
  { label: 'Transactions', icon: Receipt, path: '/transactions' },
  { label: 'Statement Import', icon: Upload, path: '/csv-upload' },
  { label: 'Commissions', icon: Handshake, path: '/commissions' },
